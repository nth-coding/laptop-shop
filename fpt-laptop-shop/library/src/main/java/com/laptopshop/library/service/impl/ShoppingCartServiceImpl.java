...
import com.laptopshop.library.dto.CartItemDto;
import com.laptopshop.library.dto.ProductDto;
import com.laptopshop.library.repository.CartItemRepository;
import com.laptopshop.library.repository.ShoppingCartRepository;
...
public class ShoppingCartServiceImpl implements ShoppingCartService {
    ...
    public void deleteCartById(Long id) {
        Optional<ShoppingCart> curr = cartRepository.findById(id);
        if(curr.isPresent()){
            ShoppingCart shoppingCart = curr.get();
    ...
    private double totalPrice(Set<CartItem> cartItemList) {
        ...
        for (CartItem item : cartItemList) {
            totalPrice += item.getProduct().getCostPrice() * item.getQuantity();
        }
        return totalPrice;
    }
